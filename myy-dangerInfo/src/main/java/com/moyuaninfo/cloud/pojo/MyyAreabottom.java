...
@Entity
@Table(name = "myy_areabottom")
@ApiModel(value = "MyyAreabottom", description = "区域底层")
@Data
public class MyyAreabottom extends BaseEntity implements Serializable {
  private static final long serialVersionUID = 1001L;

  @ApiModelProperty(value = "名称",example = "第3层",required = true)
  private String name;
  ...
  @ApiModelProperty(value = "所属河段ID",example = "11",required = true)
  private long areatwoid;

  @ApiModelProperty(value = "负责人",example = "11")
