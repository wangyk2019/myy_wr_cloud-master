...
public class CameraVO {
	...
	@ApiModelProperty(name = "colleageid",value = "高校ID",dataType = "Long",required = false,example = "101101")
	private Long colleageid;
	@ApiModelProperty(name = "id",value = "摄像头ID",dataType = "Long",required = false,example = "101101")
	private Long id;
	@ApiModelProperty(name = "laboratory",value = "实验室ID",dataType = "Long",required = false,example = "101101")
