...
import com.moyuan.cloud.security.entity.JwtUser;
import com.moyuan.cloud.security.entity.LoginUser;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        try {
            ...
            json.put("cellphone", loginUser.getPhonenumber());
            RestTemplate rest = new RestTemplate();
            String url = "http://localhost:8050" + request.getRequestURI();
            JsonResult jst = rest.postForObject(url, null, JsonResult.class, json);
