...
public abstract class BaseEntity implements Serializable {
    ...
    @CreationTimestamp
    @ApiModelProperty(name = "creattime", value = "创建时间", dataType = "Timestamp", required = true, example = "1321321654765")
    protected Timestamp creattime;

    @UpdateTimestamp
    @ApiModelProperty(name = "updatetime", value = "更新时间", dataType = "Timestamp", required = true, example = "1321321654765")
    ...
    @Column(name = "state" ,columnDefinition = " Default '1' ")
