...
public abstract class BaseEntity implements Serializable{
	...
	@ApiModelProperty(name = "creattime",value = "创建时间",dataType = "Timestamp",example = "1321321654765",hidden = true)
	protected Timestamp creattime;

	@UpdateTimestamp
	@ApiModelProperty(name = "updatetime",value = "更新时间",dataType = "Timestamp",example = "1321321654765",hidden = true)
	protected Timestamp updatetime;

	@ApiModelProperty(name = "comment",value = "备注",dataType = "String",required = false,example = "备注")
	protected String comment;

	@ApiModelProperty(name = "state",value = "状态",dataType = "String",required = true,example = "1",hidden = true)
