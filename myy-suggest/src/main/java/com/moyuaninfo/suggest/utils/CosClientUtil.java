...
public class CosClientUtil {
    ...
    // 存储通名称
    private static final String bucketName = Global.TXCLOUD_BUCKETNAME;
    // secretId
    private static final String secretId = Global.TXCLOUD_SECRETID;
    // secretKey
    private static final String secretKey = Global.TXCLOUD_SECRETKEY;

    // 1 初始化用户身份信息(secretId, secretKey)
    private static final COSCredentials cred = new BasicCOSCredentials(secretId, secretKey);
    // 2 设置bucket的区域, COS地域的简称请参照 https://cloud.tencent.com/document/product/436/6224
    private static final ClientConfig clientConfig = new ClientConfig(new Region(Global.TXCLOUD_BUCKETNAME));
    // 3 生成cos客户端
